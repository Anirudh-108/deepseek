...
const ChatLabel = ({ openMenu, setOpenMenu }) => {
  return (
    <div className="flex items-center justify-between p-2 text-white/100 hover:bg-white/10 rounded-lg text-sm group cursor-pointer">
      ...
      <div className="group relative flex items-center justify-center h-6 w-6 aspect-square hover:bg-black/80 rounded-lg">
        ...
        >
          <div className="flex items-center gap-3 hover:bg-white/10 px-3 py-2 rounded-lg">
            <Image className="w-4" src={assets.pencil_icon} alt="pencil_icon" />
            <p>Rename</p>
          </div>
          <div className="flex items-center gap-3 hover:bg-white/10 px-3 py-2 rounded-lg">
            <Image className="w-4" src={assets.delete_icon} alt="delete_icon" />
            <p>Delete</p>
          </div>
        </div>
      </div>
