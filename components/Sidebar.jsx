...
const Sidebar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between bg-[#21232F] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${
      ...
      <div>
        ...
        >
          <Image
            ...
            alt="chat-icon"
          />
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm ps-3 py-2 rounded-lg shadow-lg pointer-events-none">
            New Chat
